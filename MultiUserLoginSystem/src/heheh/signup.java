...
public class signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Security word in case password is forgotten");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(TF3)
                            .addComponent(TF4)
                            .addComponent(PF2, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(203, 203, 203)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String q,m,name,uname,pass,age,sex,forgor;
            Connection con;
            name=TF1.getText();
            age=TF2.getText();
            sex=TF3.getText();
            ...
            m="insert into signup values('"+name+"','"+age+"','"+sex+"','"+uname+"','"+pass+"','"+forgor+"');";
            q="insert into login values('"+uname+"','"+pass+"','"+forgor+"');";
            st.executeUpdate(m);  
                        st.executeUpdate(q);
